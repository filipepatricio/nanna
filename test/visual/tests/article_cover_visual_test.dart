...
void main() {
  final coverLarge = ArticleCover.large(
    article: TestData.article,
    onTap: () {},
  );
  final coverLargeVariant = ArticleCover.large(
    article: TestData.article,
    isNew: true,
    showNote: true,
  ...
  final coverMedium = ArticleCover.medium(
    article: TestData.article,
    onTap: () {},
  );
  final coverMediumVariant = ArticleCover.medium(
    article: TestData.article,
    isNew: true,
    showNote: true,
    showRecommendedBy: true,
  ...
  Widget coverSmall(BuildContext context) => SizedBox(
      ...
      await tester.startApp(
        initialRoute: placeholderRouteWrapper(
          ...
          children: [
            ...
            coverMediumVariant,
            Builder(
              builder: (context) => coverSmall(context),
            ),
          ],
        ),
      );
