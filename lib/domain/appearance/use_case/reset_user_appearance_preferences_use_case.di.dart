...
@injectable
class ResetUserAppearancePreferencesUseCase {
  ResetUserAppearancePreferencesUseCase(
  ...
  Future<void> call() async {
    ...
    return _appearancePreferencesStore.resetUserAppearancePreferences(currentUserUuid);
  }
}
