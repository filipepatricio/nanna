...
@injectable
class GetTermsOfServiceLegalPageUseCase {
  GetTermsOfServiceLegalPageUseCase(this._legalPageRepository);

  final LegalPageRepository _legalPageRepository;

  Future<LegalPage> call() => _legalPageRepository.getTermsOfServicePage();
}
